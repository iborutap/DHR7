...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
											...
											<table class="table table-bordered">
												<thead>
													<tr>
														...
														<th width="15%" class="text-right">Amount (Rp)</th>
								...
								<?php } else { ?>
									...
									<div class="row">
										<div class="col-sm-6">
											<h3 class="text-success" style="margin-top:0">
												Net Salary Payable:
												Rp<?php echo number_format(($totalEarnings - $totalDeductions), 2, '.', ','); ?>
		...
		<strong> &copy; <?php echo date("Y");?> Payroll Management System | </strong> Digital HR Kelompok 7
		</footer>
	</div>
